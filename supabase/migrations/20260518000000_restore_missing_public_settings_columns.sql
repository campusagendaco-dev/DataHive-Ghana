-- 20260518000000_restore_missing_public_settings_columns.sql
-- Merges the recently added notification sound columns with all historically exposed frontend fields (tutorial videos, promo configs, etc).
