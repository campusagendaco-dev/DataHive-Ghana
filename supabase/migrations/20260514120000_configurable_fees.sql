-- Add fee configuration to system_settings
ALTER TABLE public.system_settings
  ADD COLUMN IF NOT EXISTS paystack_deposit_fee_percent numeric(5,4) DEFAULT 0.0300,
  ADD COLUMN IF NOT EXISTS withdrawal_fee_flat numeric(12,2) DEFAULT 1.00,
  ADD COLUMN IF NOT EXISTS withdrawal_fee_percent numeric(5,4) DEFAULT 0.0100;

-- Update the public view to include these new columns
...
SELECT
  ...
  paystack_deposit_fee_percent, withdrawal_fee_flat, withdrawal_fee_percent,
...
-- Update request_withdrawal to use these dynamic settings
