-- Migration: Restore API Test Mode and Hardening
-- Redefines api.create_order_rpc to safely support sandbox testing alongside parent commission logic.
...
BEGIN
  ...
  INSERT INTO public.orders (
    ...
    v_final_price, v_admin_profit, CASE WHEN p_test_mode THEN 'fulfilled' ELSE 'pending' END, v_cost_price, v_parent_agent_id, v_parent_profit
  );
