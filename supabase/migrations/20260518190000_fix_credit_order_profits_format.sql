-- 20260518190000_fix_credit_order_profits_format.sql
-- Corrects PL/pgSQL format specifiers in credit_order_profits function from %.2f to %s.
-- This prevents the 'unrecognized format() type specifier "."' database exceptions
-- that crash order fulfillment transactions and cause orders to get permanently stuck in processing.
