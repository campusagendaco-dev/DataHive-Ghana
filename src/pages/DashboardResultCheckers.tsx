...
const DashboardResultCheckers = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 text-center">
      ...
      <h1 className="font-display text-3xl font-black text-foreground mb-3">Result Checkers</h1>
      <p className="text-muted-foreground text-sm max-w-sm">
        Purchase WAEC, BECE, and other result checker PINs for your customers. This feature is coming very soon.
      </p>
    </div>
  );
};
