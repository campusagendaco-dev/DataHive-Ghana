                ...
                <h3 className="font-black text-xl text-foreground mb-6 flex items-center gap-2 tracking-tight">
                 ...
                 <div className="flex gap-2 p-1.5 bg-muted rounded-2xl border border-border mb-6">
                   <button
                     ...
                     className={`flex-1 py-3 text-xs font-black uppercase tracking-wider rounded-xl transition-all ${walletType === "main" ? "bg-amber-500 text-black shadow-lg" : "text-muted-foreground hover:text-foreground hover:bg-background/50"}`}
                   >
                     Main Wallet
                   </button>
                   <button
